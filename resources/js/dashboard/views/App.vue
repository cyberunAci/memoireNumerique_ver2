...
<div>
        <v-card flat>
          <v-card-text>
            ...
            <h1 class="text-center justify-center py-6">Presentation du projet</h1><br>
              <v-container class="text-center justify-center py-6">
            <p>Mémoire numérique est un projet porté par des jeunes Trois-Bassinois qui a pour ambition de réaliser une mémoire numérique des Hauts avec l'ensemble des acteurs qui ont contribué à la construction et l'épanouissement de ce territoire.</p>
            ...
            Les Hauts sont également dépositaires d'un riche patrimoine immatériel. La langue créole est intimement liée à l'identité réunionnaise ; elle s'est enrichie au fil des siècles de mots d'origine malgache, indienne ou chinoise.</p>
            ...
            Comme dirait le groupe de musique réunionnais LINDIGO, tiré de LafrikndMada : « Kan ou koné oussa ou sorte, Ou koné oussa ou sava, Mwin lé né la Réunion, Oussa néna tout ban nasyon ».</p>
              </v-container>

            <h1 class="text-center justify-center py-6">Presentation de Cyberun</h1><br>
              <v-container class="text-center justify-center py-6">
                <p> 
                ...
                En ce sens, tous nos projets s’articulent  autour des notions d’innovation, de solidarité, de Tradition et de Divertissement. Site : <a href="http://cyberun.org/">Cyberun.org</a>. 
                </p>
              </v-container>
              </v-container>          
          </v-card-text>
